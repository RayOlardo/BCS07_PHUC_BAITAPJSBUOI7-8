...
function tinhTongSoDuongMang(arr) {
  //input(number)
  // output:number
...
document.getElementById("btnNhapSo_2").onclick = function () {
  ...
  // In ra màn hình;
  document.getElementById("ketQua_2").innerHTML = "có " + demSo + " số dương";
};
//Các bước xử lý:
...
document.getElementById("btnNhapSo_4").onclick = function () {
  ...
  document.getElementById("ketQua_4").innerHTML =
    "Số dương nhỏ nhất = " + bienMinDuong;
};
...
function doiViTri() {
  ...
  //In ra màn hình;
  document.getElementById("ketQua_6").innerHTML =
    "Mảng sau khi đỗi là: " + arrNew;
}
...
document.getElementById("btnNhapSo_7").onclick = function () {
  ...
  //In ra màn hình;
  document.getElementById("ketQua_7").innerHTML =
    "thứ tự tăng dần: " +
...
document.getElementById("btnNhapSo_8").onclick = function () {
  ...
  //In ra màn hình;
  document.getElementById("ketQua_8").innerHTML =
